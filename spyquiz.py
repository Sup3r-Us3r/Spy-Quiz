...
|                                                                                 |
|      É dessa vez as coisas vão mudar, ache a senha que estão criptografada      |
|_________________________________________________________________________________|
...
''')
	...
	if opcao1 == "1":
		...
		sleep(3)
		print("")
		os.system("curl -s https://raw.githubusercontent.com/Sup3r-Us3r/Spy-Quiz/master/japooc2s.txt")
		responder = input("\n\033[1;36mResposta:\033[1;m ")
		if responder == japooc2s:
			print("\n\033[1;32m[*] Resposta correta!\033[1;m\n")
			input("\n\033[1;36mPressione ENTER para continuar...\033[1;m ")
			Bloco18()
		else:
