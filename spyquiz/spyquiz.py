...
def Distro():
	print('''
[*] Escolha sua distribuição para a instalação do pacote sl para poder iniciar o teste 3:
...
def Bloco6():
	...
	Apresentacao()
	print('''
       [*] Nível - #6: A senha está no arquivo pass.psd
 ______________________________________________
|                                              |
|      Download - https://goo.gl/8XCUxH        |
|______________________________________________|
...
3) Sair;
''')
	imagem = input("\033[1;36mOpção:\033[1;m ")
	if imagem == "1":
		login = input("\n\033[1;32m[*] Login: \033[1;m")
		senha = input("\033[1;32m[*] Senha: \033[1;m")
		if login == VLogin:
